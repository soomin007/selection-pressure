...
const SECTIONS: readonly Section[] = [
  {
    title: "형질 도감",
    intro: "형질은 한 종을 이루는 저울입니다. 모든 종은 보통에서 시작해 카드로 조금씩 키웁니다. 화면에는 날숫자 대신 단계로 보여줍니다. 속도·시야·공격력·번식력·무리 성향은 약함·보통·강함·막강·최강 다섯 단계, 수영·날개·초음파·독·원거리는 없음·보통·강함 세 단계, 대사는 낮음·보통·높음입니다.",
    entries: [
      {
        term: "단계 읽는 법",
        svg: SVG.scale,
        desc: "형질값은 화면에 단계로 보입니다. 모든 종은 '보통'에서 시작해, 오래 갈고 닦은 종은 속도·시야 같은 형질이 강함을 지나 막강·최강까지 오릅니다.",
        note: '카드는 형질을 한두 단계씩 올리거나 내립니다. 대사·식성은 좋고 나쁨이 없어(낮음/높음, 초식/육식) 다가오는 환경이 유불리를 정합니다.',
      },
      {
        term: "속도",
        svg: SVG.speed,
