    ...
    entries: [
      {
        term: "한 판의 흐름",
        svg: SVG.flow,
        desc: "시작 종을 고르고, 화면을 탭해 우두머리를 이끕니다. 탭한 곳이 사냥할 수 있는 상대면 쫓아가 물고, 그 밖의 곳이면 그리로 갑니다. 나머지 무리는 스스로 살면서 우두머리를 따라옵니다. 첫 시대는 무리를 먹여 키우는 것만 하면 되고, 둘째 시대부터는 라운드마다 시험이 하나 주어져 통과하지 못하면 불씨가 하나 꺼집니다. 마지막 대멸종까지 살아남으면 승리입니다.",
      },
      {
        term: "라운드 시험과 불씨",
        svg: SVG.trophy,
        desc: "첫 시대에는 시험이 없습니다. 둘째 시대부터 채집 라운드마다 시험이 하나 걸립니다. 사냥 몇 번, 먹이 몇 번, 새끼 몇 마리, 무리 몇 마리처럼 그 라운드 안에 채워야 하는 목표입니다. 목표는 라운드가 시작되기 전 카드 고르는 화면에 미리 나오니, 그걸 보고 카드를 고르세요.",
        note: "불씨는 이 혈통에 남은 기회입니다. 다섯 개로 시작해 시험에 질 때마다 하나씩 꺼지고, 모두 꺼지면 판이 끝납니다. 첫 시대에는 시험이 없어 불씨가 줄지 않습니다. 보스를 물리치거나 다음 시대로 넘어가면 하나 되살아납니다.",
      },
      {
        term: "카드 고르기",
        svg: SVG.card,
