...
const SECTIONS: readonly Section[] = [
  {
    ...
    entries: [
      ...
      },
      {
        term: "무리 성향",
        svg: SVG.herding,
        desc: "함께 모여 다닙니다. 무리 성향이 아주 높은 종이 실제로 뭉쳐 있으면 포식자가 그 무리를 아예 노리지 않습니다(무리 방어). 모이면 서로 보온도 합니다.",
        rows: [
          { k: "85 이하", v: "무리 방어 없음. 보온만", bar: 0.2 },
          { k: "86 이상 + 곁에 2마리", v: "포식자가 안 건드립니다", bar: 1 },
          { k: "무리에서 떨어지면", v: "방패가 사라집니다", bar: 0 },
        ],
        note: "뭉쳐 있어야 방패가 섭니다. 홀로 먹이를 찾아 나선 개체는 잡아먹힙니다. 포식자는 늘 가장자리와 낙오자를 노립니다. 다산 초식 무리 프리셋과 무리 카드로 키웁니다.",
      },
      {
        term: "식성",
        svg: SVG.diet,
