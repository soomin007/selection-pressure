...
const SECTIONS: readonly Section[] = [
  {
    title: "형질 도감",
    intro: "모든 형질은 0에서 100 사이입니다. 모든 종은 50에서 시작하고, 카드 한 장은 보통 15에서 28을 더하거나 뺍니다.",
    entries: [
      {
        term: "수치 읽는 법",
        svg: SVG.scale,
        desc: "형질은 0(가장 낮음)에서 100(가장 높음) 사이 값입니다. 모든 종은 50에서 시작합니다.",
        note: '예를 들어 "속도 +22" 카드는 속도를 50에서 72로 올린다는 뜻입니다. 아래 각 형질에서 그 값이 실제 게임에서 얼마인지 볼 수 있습니다.',
      },
      {
        term: "속도",
        svg: SVG.speed,
      ...
      },
      {
        ...
        rows: [
          ...
          { k: "50 (기본)", v: "0.8%", bar: 0.62, base: true },
          { k: "100", v: "1.3% (약 4배)", bar: 1 },
        ],
