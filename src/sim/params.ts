...
export const SIM = {
  ...
  wildDriftStep: 0.012, // 매 진화 때 형질별 무작위 드리프트 폭(독립 rng — 종마다 조금씩 달라짐)
  ...
  swimThreshold: 0.65, // 수영 형질이 이 이상이면 물에 들어가고 바다 먹이를 먹는다(기본 0.5 → 카드 1장으로 도달)
  aquaticOnlyThreshold: 0.9, // 수영이 이 이상이면 물 전용(육지에 못 들어감) — 진짜 물고기. 0.65~0.9 는 수륙양용
