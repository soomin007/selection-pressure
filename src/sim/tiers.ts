 ...
 *
 * **아래 표는 계산이 아니라 실측이다** (`npm run probe -- tiers` · 실제 90장 풀 · 희귀도 가중 ·
 ...
 * | 어떻게 골랐나 | 12장 | 17장 | 22장 |
 * |---|---|---|---|
 * | 한 범주만 판다 | 15.8 / 7.1 (III) | **19.5 / 9.4 (IV 61%)** | 22.0 / 11.8 (IV 93%) |
 * | 두 범주를 판다 | 15.8 / 10.7 (III+II) | **19.5 / 14.2 (듀오 68%)** | 21.9 / 18.1 (IV+III) |
 * | 매번 가장 큰 카드 | 14.4 / 10.4 (III+II) | 18.0 / 14.2 (III+III) | 20.7 / 17.8 (IV+III · 듀오 4) |
 * | 아무거나 고른다 | 10.8 / 8.2 (II · **3단 0.17개**) | 13.5 / 10.2 (II~III) | 16.2 / 12.7 (III+II) |
 *
 * 마지막 줄이 이 재설계의 목표다. 예전엔 정점 넷이 런 끝에 **반드시** 다 찍혔는데, 이제 손 놓은
 * 판은 **관문 자격을 하나도 못 얻는다**(3단이 평균 0.15개). 그리고 다섯 범주 전부 4단은 원리적으로
 * 불가능하다 — 그러려면 100 도장이 필요한데 가장 후한 판의 공급이 약 40이다.
