...
export const CATEGORY_DESC: Record<Category, string> = {
  ...
  herd: "새끼와 지침 줄 수. 키울수록 나눠 먹고 병이 돕니다.",
};
...
/**
 * 무리 → **지침 시트에 쓸 수 있는 줄 수** (**[사용자 2026-09-11]** 감독형 전환).
 * 옛 「목소리가 닿는 거리」(HERD_VOICE · **[사용자 2026-08-06]** 확정 · 520~4000px)를 대체한다: 감독의 말은
 * 팀 전체에 닿으므로 거리는 사라지고, 대신 조직이 클수록 더 많은 지침을 동시에 굴린다(FF12 갬빗의
 * 칸이 성장으로 열리는 것과 같은 모양). 값은 내 판단 · 실플레이 뒤 다시 잰다.
 */
